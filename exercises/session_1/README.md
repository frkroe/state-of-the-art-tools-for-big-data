...
### 3. Getting started - Recap on PySpark
...
### 6. Extend the `example_pipeline` by inserting the data into PostgreSQL.
...
### 7. Add a trigger to the pipeline
...
### 8. Create a new pipeline to process the Tickets dataset
